...
=======
        <div className="flex flex-wrap gap-5 text-sm text-[hsl(var(--secondary))]"><Link href="/auth/security-settings">Security</Link><Link href="/#mission">Mission</Link><Link href="/#ai">AI</Link></div>
